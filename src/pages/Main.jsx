            ...
            <div>
              ...
              <div className="text-content">
                <p>
                  ...
                  широкий спектр высококачественных услуг для различных
                  отраслей. Наша команда опытных и талантливых специалистов
                  обладает глубокими знаниями и многолетним опытом в создании
                  реалистичных, высокодетализированных трехмерных моделей,
                  анимации и визуализации. Мы стремимся к совершенству,
                  используя передовые технологии и программное обеспечение,
                  чтобы предоставить клиентам исключительные результаты, которые
                  превосходят ожидания. Студия использует передовые программные
                  решения и технологии, чтобы обеспечить высокое качество и
                  точность наших моделей. Мы гордимся индивидуальным подходом к
                  каждому клиенту и стремимся превзойти ожидания, обеспечивая
                  прозрачное общение и своевременную сдачу проектов. Обращайтесь
                  ...
                  <div className="modal-content-wrapper">
                    ...
                    <div className="modal-text-content">
                      ...
                      <p>
                        Архитектурная 3D-визуализация — это процесс создания
                        реалистичных трехмерных изображений, видеороликов или
                        интерактивных моделей зданий, интерьеров и ландшафтов.
                        Она используется архитекторами, дизайнерами,
                        застройщиками и другими участниками строительной
                        индустрии для различных целей, от презентации проектов
                        потенциальным клиентам до планирования и контроля за
                        строительством.
                      </p>
                      ...
                      >
                        ...
                        <li>
                          Планирование и проектирование: Использование
                          3D-моделей для обнаружения и исправления ошибок на
                          ранних стадиях проектирования, а также для оптимизации
                          планировки и дизайна.
                        </li>
                        <li>
                          Маркетинг и продажи: Создание рекламных материалов и
                          каталогов с использованием высококачественных
                      ...
                      <p>
                        Наша цель — не просто создать красивые картинки, а
                        предоставить вам мощный инструмент для успешной
                        реализации ваших проектов. Закажите проект и убедитесь в
                        этом сами.
                      </p>
                      <button>
                        <h3>Заказать проект</h3>
            ...
            <div className="section">
              ...
              <div>
                ...
                <p>
                  ...
                  впечатления! С самого начала, ребята проявили себя как
                  настоящие профессионалы, внимательно выслушав все наши
                  пожелания и предложив креативные решения. Процесс создания
                  3D-модели был полностью прозрачным – мы всегда были в курсе
                  хода работы и могли оперативно вносить корректировки. Качество
                  исполнения просто потрясающее, модель получилась детально
                  проработанной и невероятно реалистичной. И всё это – в
                  оговоренные сроки! Большое спасибо за профессионализм и
                  индивидуальный подход! Рекомендую всем, кто ценит качество и
                  оперативность!
                </p>
              </div>
              <hr />
            ...
            <div className="section">
              ...
              <div>
                ...
                <p>
                  ...
                  высочайший профессионализм в моделировании, но и чувство
                  стиля, воплотив в жизнь наши самые смелые идеи. Быстрая
                  коммуникация и оперативная обратная связь делали
                  сотрудничество максимально комфортным. Результат превзошел все
                  ожидания – модель выглядит просто потрясающе! Огромное спасибо
                  за ваш труд и профессионализм! Безусловно, буду обращаться к
                  вам снова и рекомендовать всем своим знакомым!
                </p>
              </div>
            </div>
          </div>
