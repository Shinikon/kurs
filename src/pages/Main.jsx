        ...
        <div className="main__block_aboutUs">
          <div>
            ...
            <div className="text-content">
              <p>
                Metaform — ведущая студия 3D-моделирования, предлагающая услуги
                высокого качества для разных отраслей. Наша команда опытных
                специалистов создает реалистичные и детализированные 3D-модели,
                анимацию и визуализацию. Мы используем передовые технологии и ПО
                для достижения исключительных результатов. Эксперты применяют
                современные программные решения для обеспечения надежности и
                точности моделей. Мы ориентируемся на индивидуальный подход к
                каждому клиенту, обеспечивая прозрачность и своевременную сдачу
                проектов. Обращайтесь за качественным 3D-моделированием.
              </p>
            </div>
          </div>
          <Link to="/contacts">
